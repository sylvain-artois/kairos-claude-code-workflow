...
[`/kairos:create-test-plan`](../../skills/create-test-plan/SKILL.md) generates and
[`/kairos:qa`](../../skills/qa/SKILL.md) executes. It would live at `api/qa/TEST_PLAN_HEALTHZ_LITE.md`.
